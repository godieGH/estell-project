...
export default defineConfig((ctx) => {
  return {
    ...
    build: {
      ...
      vueRouterMode: 'history', //You can use 'hash', too // available values: 'hash', 'history'
      // vueRouterBase,
      //vueDevtools,
      // vueOptionsAPI: false,

      chunkSizeWarningLimit: 4000, // rebuildCache: true, // rebuilds Vite/linter/etc cache on startup
    ...
    pwa: {
      ...
      manifest: {
        name: 'Estell App',
        short_name: 'Estell',
        description: 'Estell Social Media App',
        scope: '/',
        start_url: '/',
        display: 'standalone',
        orientation: 'natural',
